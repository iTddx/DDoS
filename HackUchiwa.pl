#!/usr/bin/perl
#####################################################
# DDoS Script by UchiwaHack , UchiwaHack number 1 :D
#
...
if ($help || !$ip) {
  print <<'EOL';
 The usage of command is perl UchiwaHack.pl a.b.c.d
EOL
  exit(1);
}
...
printf "[0;32m>> Made by UchiwaHack  \n";
printf "[0;32m>>                  
...
|  |     |  | | |       |   ___   |   |  |      \ \  \ / /   / /    / /______\ \
|  |_____|  | | |____   |  |   |  |   |  |       \ \  / /\  / /    / /        \ \ 
|___________| |______|  |__|   |__|   |__|        \_\/_/\_\/_/    /_/          \_\    
                                    \n";                     
